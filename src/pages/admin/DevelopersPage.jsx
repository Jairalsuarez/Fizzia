  ...
  return (
    <div className="p-6">
      ...
      <div className="flex gap-6 h-[calc(100vh-180px)]">
        <div className="w-1/3">
          <DeveloperList selectedId={selectedDeveloper?.id} onSelect={setSelectedDeveloper} refreshKey={refreshKey} />
        </div>
        <div className="flex-1">
          {selectedDeveloper ? (
            <DeveloperDetail developer={selectedDeveloper} onUpdate={(updated) => { setRefreshKey(k => k + 1); if (updated) setSelectedDeveloper(updated) }} />
          ) : (
