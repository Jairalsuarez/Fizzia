                ...
                <div className="flex gap-1 bg-dark-800 rounded-lg p-0.5">
                  <button
                    ...
                    className={`cursor-pointer px-3 py-1.5 rounded-md text-xs font-medium transition-all ${
                      activeTab === 'messages' ? 'bg-[var(--accent)] text-white' : 'text-dark-400 hover:text-white'
                    }`}
                  >
                    Mensajes
                  </button>
                  <button
                    ...
                    className={`cursor-pointer px-3 py-1.5 rounded-md text-xs font-medium transition-all ${
                      activeTab === 'files' ? 'bg-[var(--accent)] text-white' : 'text-dark-400 hover:text-white'
                    }`}
                  >
                    Archivos
                  </button>
                ...
                <div className="mt-3 flex w-fit gap-1 rounded-lg bg-dark-800 p-0.5">
                  <button
                    ...
                    className={`cursor-pointer rounded-md px-3 py-1.5 text-xs font-medium transition-all ${
                      conversationMode === 'client' ? 'bg-[var(--accent)] text-white' : 'text-dark-400 hover:text-white'
                    }`}
                  >
                    Cliente
                  </button>
              ...
              <>
                            ...
                            <div className={`flex items-end gap-1.5 ${isMine ? 'flex-row-reverse' : ''}`}>
                              <button
                                ...
                                className={`cursor-pointer rounded-2xl px-4 py-3 text-left text-sm ${
                                  isMine
                                    ? status === 'error' ? 'bg-red-500/80 text-white rounded-br-sm' : 'bg-[var(--accent)] text-white rounded-br-sm'
                ...
                <form onSubmit={handleSend} className="p-3 border-t border-dark-800 flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-dark-950 border border-dark-700 rounded-xl text-white placeholder-dark-500 focus:outline-none focus:border-[var(--accent)] text-sm"
              ...
              <div className="min-h-0 flex-1 overflow-y-auto p-4 space-y-4">
                <div className="bg-dark-800/50 rounded-xl p-4">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-dark-950 border border-dark-700 rounded-lg text-white text-sm placeholder-dark-500 focus:outline-none focus:border-[var(--accent)] resize-none transition-all mb-2"
                    rows={2}
