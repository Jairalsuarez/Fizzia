...
export function HeroSection() {
  ...
  return (
    <section id="inicio" ref={ref} className="relative flex min-h-[100dvh] items-center overflow-hidden bg-dark-950 pt-24 pb-16">
      ...
      <div className={`relative mx-auto w-full max-w-6xl px-4 sm:px-6 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
