...
export function NewsletterSection() {
  ...
  const heading = t('newsletter.heading')
          ...
          <div className="relative text-center max-w-2xl mx-auto">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                ...
                <button
                  type="submit"
                  className="px-8 py-3 bg-fizzia-500 hover:bg-fizzia-400 text-white font-bold rounded-xl transition-colors shadow-lg shadow-fizzia-500/25 whitespace-nowrap cursor-pointer"
                >
                  {t('newsletter.button')}
                </button>
              </form>
